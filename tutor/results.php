            ...
            <div class="records">
                ...
                <table>
                    ...
                    <?php foreach($quizzes as $quiz){
                        ...
                        $result = $db->fetchAll("SELECT * FROM quiz_results WHERE quiz_id = ?", [$quiz['id']]);
                        if(is_countable($result) && count($result) != 0){
                            $quiz_column = array_column($result, 'percentage');
                            $class_percentage = number_format(array_sum($quiz_column) / count($result), 1);
