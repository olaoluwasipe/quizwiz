<?php 
    ...
    if(isset($_SESSION['user'])){
       ...
       if(isset($_GET['student_id'])){
        ...
        $student = $db->fetchOne("SELECT * FROM users WHERE id = ? AND type = ?", [$student_id, 0]);
        if(!$student){
...
<body>
    ...
    <div class="topnav">
        ...
        <div class="start">
            ...
            <div class="pageTitle">Student profile</div>
        </div>
    ...
    <div class="sidenav" id="sidenav">
        ...
        <div class="sidelinks">
            ...
            <a href="students.php" class="sidelink active">
    ...
    <div id="truePage">
        ...
        <div class="tdv">
            ...
            <div class="breadcrumbs">
                <a href="students.php" class="crumb">students</a>
                <i class="icon fas fa-angle-double-right"></i>
                <div class="curr"><?php echo $student['firstName'] . " " . $student['lastName']; ?></div>
            </div>
            ...
            <div class="rlv spec">
                ...
                <div class="axis">
                    ...
                    <div class="profile">
                        ...
                        <div class="user-info">
                            <div class="username"><?php echo $student['firstName'] . " " . $student['lastName']; ?></div>
                            <div class="usermail"><?php echo $student['email']; ?></div>
                            <div class="userphone"><?php echo $student['phone']; ?></div>
                        </div>
                ...
                <div class="axis">
                    ...
                    <div class="records">
                        ...
                        <div class="topped">
                            <div class="heading">All Quiz Results</div>
                        </div>
                        ...
                        <table>
                            ...
                            <?php 
                                $results = $db->fetchAll("SELECT * FROM quiz_results WHERE user_id = ?",[$student['id']]);
                                foreach($results as $result){
                                    $quiz = $db->fetchOne("SELECT * FROM quizzes WHERE id = ?", [$result['quiz_id']]);
                                    $res = $db->fetchAll("SELECT * FROM quiz_results WHERE quiz_id = ?",[$quiz['id']]);
                                    if($quiz){
                                        $quiz_column = array_column($res, 'percentage');
                                        $class_percentage = number_format(array_sum($quiz_column) / count($res), 1); ?>
                                        <tr>
                                            <td><?php echo $quiz['title'] ?></td>
                                            <td><?php echo $student['firstName'] . " " . $student['lastName']; ?></td>
                                            <td><?php echo $result['score'] . " / " . $quiz['scorePerQuestions'] * $quiz['noOfQuestions'] ?></td>
                                            <td><?php echo $class_percentage; ?></td>
                                        </tr>
                                    <?php }
                                }
                            ?>
