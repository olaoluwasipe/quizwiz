<?php 
 ...
 $banks = $db->fetchAll("SELECT * FROM questionbank WHERE user_id = ?", [$user['id']]);
    if(isset($_GET['quiz_id'])){
        ...
        $results = $db->fetchAll("SELECT * FROM quiz_results WHERE quiz_id = ?", [$quiz['id']]);
    }else{
                        ...
                        <div class="details">
                            ...
                            <div class="port end">
                                <button>
                                    ...
                                    <div class="text">publish results</div>
                                </button>
                            </div>
                    ...
                    <div class="records">
                        ...
                        <table>
                            ...
                            foreach($results as $result){
                                $userr = $db->fetchOne("SELECT * FROM users WHERE id = ?", [$result['user_id']]);
                                ...
                                <tr>
                                    ...
                                    <td><?php echo str_pad($result['timeFinished'], 5, '0', STR_PAD_LEFT); ?></td>
                                </tr>
