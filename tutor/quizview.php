                ...
                <div class="axis">
                    ...
                    <div class="quizzer">
                        ...
                        <div class="top">
                            ...
                            <div class="quizcode"><b>Code:</b> <?php echo $quiz['quizCode']; ?></div>
                        </div>
                        ...
                        <div class="details">
                            ...
                            <div class="port">
                                <div class="tag">score per question</div>
                                <div class="unit"><?php echo $quiz['scorePerQuestions']; ?></div>
                            </div>
                            ...
                            <div class="port">
                                <div class="tag">question bank used</div>
                                <div class="unit"><?php $bank = $db->fetchOne("SELECT * FROM questionbank WHERE id = ?", [$quiz['questionBank']]); echo $bank['name']; ?></div>
                            </div>

                            <div class="selecter">
                                <input type="checkbox" name="" id="" <?php echo $quiz['isRandom'] == "yes" ? "checked" : ""; ?>>
                                <div class="unit">randomized questions</div>
                            </div>

                            <div class="port end">
                                <button onclick="editQuiz(<?php echo $quiz['id'] ?>, '<?php echo $quiz['title'] ?>', '<?php echo $quiz['description'] ?>', '<?php echo $quiz['duration'] ?>', '<?php echo $quiz['noOfQuestions'] ?>', '<?php echo $quiz['scorePerQuestions']; ?>', '<?php echo $quiz['dateScheduled']; ?>', '<?php echo $quiz['dateEnd'] ?>', '<?php echo $quiz['questionBank'] ?>', '<?php echo $quiz['isRandom'] ?>', '<?php echo $quiz['showAnswers'] ?>')">
...
<form action="" method="post" class="modalFormer quizForm" id="quizForm">
    ...
    <form action="" method="post" class="quizForm modalFormer" id="updateForm">
            ...
            <div class="mid">
                ...
                <div class="part">
                    <label for="title">title</label>
                    <input type="text" name="title" id="quizTitle" placeholder="Quiz title">
                </div>
                ...
                <div class="part small">
                    ...
                    <select name="questions" id="quizQuestions">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                ...
                <div class="part small">
                    <label for="score">Score per question</label>
                    <select name="score" id="quizScore">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                ...
                <div class="part">
                    <label for="describe">Description</label>
                    <textarea name="describe" id="quizDesc"></textarea>
                </div>
                ...
                <input type="hidden" id="updateQuiz" name="updateQuiz" value="createQuiz">
