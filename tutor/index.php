...
<body>
    ...
    <div class="sidenav" id="sidenav">
        ...
        <div class="sidelinks">
            ...
            <a href="index.php" class="sidelink active">
        ...
        <table>
            ...
            <div class="axis">
                ...
                <div class="students">
                    ...
                    <div class="topped">
                        <div class="heading">students list</div>

                        <a href="students.php" class="cta-link">students <div class="icon fas fa-arrow-right-long"></div></a>
                    </div>
                    ...
                    <div class="opts">
                        ...
                        $x = 0;
                         foreach($quizzes as $quiz){
                            ...
                            $x++; ?>
                            <div class="opt <?php echo $s ?>"><?php echo $quiz['title']; ?></div>
                         <?php }
                        ?>
                    </div>
                    ...
                    <?php 
                        ...
                        foreach($quizzes as $quiz){
                            ...
                            $x++;
                            $quiz_id = $quiz['id'];
                            $results = $db->fetchAll("SELECT * FROM quiz_results WHERE quiz_id= ?", [$quiz_id]); ?>
                            <div class="list <?php echo $s ?>">
                            <?php if(count($results) > 0){
                                $averageCol = array_column($results, 'percentage');
                                $average = number_format(array_sum($averageCol) / count($results), 1);
                                foreach(array_slice($results, 0, 4) as $result){
                                    $user = $db->fetchOne("SELECT * FROM users WHERE id = ?", [$result['user_id']]); ?>

                                    <div class="student-tab">

                                        <div class="image"><img src="../learner/assets/img/<?php echo isset($user['image']) ? $user['image'] : 'default.webp' ?>" alt=""></div>

                                        <div class="details">

                                            <div class="info">
                                                <div class="username"><?php echo $user['firstName'] . " " . $user['lastName']; ?></div>

                                                <div class="stats">
                                                    <div class="rank">Class average: <?php echo $average ?>%</div>
                                                    <div class="avg">Score: <?php echo $result['percentage']; ?>%</div>
                                                </div>
                                            </div>

                                            <a href="userprofile.php" class="cta-icon"><i class="fas fa-arrow-circle-right"></i></a>
...
<form action="" method="post" class="modalFormer quizForm" id="quizForm">
    ...
    <script src="../tutor/assets/js/main.js"></script>
</body>
</html>